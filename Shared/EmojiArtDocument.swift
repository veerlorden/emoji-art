...
extension UTType {
    static let emojiart = UTType(exportedAs: "vadimburkin.emojiart")
}
...
class EmojiArtDocument: ReferenceFileDocument
{
    ...
    func removeEmojis(_ emojis: Set<EmojiArtModel.Emoji>, undoManager: UndoManager?) {
        undoablyPerform(operation: "Remove Emoji", with: undoManager) {
            emojiArt.removeEmojis(withIds: emojis.map { $0.id })
        }
    }
